...
github_event!("Discussion", "Created", "Edited", "Deleted", "Transferred", "Pinned", "Unpinned", "Labeled", "Unlabeled", "Locked", "Unlocked", "CategoryChanged", "Answered", "Unanswered");
github_event!("DiscussionComment", "Created", "Edited", "Deleted");
github_event!("Fork");
github_event!("Gollum");
github_event!("IssueComment", "Created", "Edited", "Deleted");
github_event!("Issues", "Opened", "Edited", "Deleted", "Transferred", "Pinned", "Unpinned", "Closed", "Reopened", "Assigned", "unassigned", "Labeled", "Unlabeled", "Locked", "Unlocked", "Milestoned", "Demilestoned");
github_event!("Label", "Created", "Edited", "Deleted");
github_event!("MergeGroup", "ChecksRequested");
github_event!("Milestone", "Created", "Closed", "Opened", "Edited", "Deleted");
github_event!("PageBuild");
github_event!("Project", "Created", "Closed", "Reopened", "Edited", "Deleted");
github_event!("ProjectCard", "Created", "Moved", "Converted", "Edited", "Deleted");
github_event!("ProjectColumn", "Created", "Updated", "Moved", "Deleted");
github_event!("Public");
github_event!("PullRequest", "Assigned", "Unassigned", "Labeled", "Unlabeled", 
  "Opened", "Edited", "Closed", "Reopened", "Synchronized", "ConvertedToDraft",
  "ReadyForReview", "Locked", "Unlocked", "ReviewRequested", "ReviewRequestedRemoved",
  "AutoMergeEnabled", "AutoMergeDisabled",
);
github_event!("PullRequestReview", "Submitted", "Edited", "Dismissed");
github_event!("PullRequestReviewComment", "Created", "Edited", "Deleted");
github_event!("PullRequestTarget", "Assigned", "Unassigned", "Labeled", "Unlabeled", 
  "Opened", "Edited", "Closed", "Reopened", "Synchronized", "ConvertedToDraft",
  "ReadyForReview", "Locked", "Unlocked", "ReviewRequested", "ReviewRequestedRemoved",
  "AutoMergeEnabled", "AutoMergeDisabled"
);
...
github_event!("Release", "Published", "Unpublished", "Created", "Edited", "Deleted", "Prereleased", "Released");
